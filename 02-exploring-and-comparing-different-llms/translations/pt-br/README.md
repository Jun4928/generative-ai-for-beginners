...
[![Exploring and comparing different LLMs](../../images/02-lesson-banner.png?)](https://aka.ms/gen-ai-lesson2-gh?WT.mc_id=academic-105485-koreystt)
...
Saiba mais sobre como você pode [usar o RAG](https://learn.microsoft.com/azure/search/retrieval-augmented-generation-overview?) para o seu negócio.
...
Vamos para a Lição 3, onde veremos como podemos [Criar IA Generativa de forma Responsável](../../../03-using-generative-ai-responsibly/translations/pt-br/README.md?)!
